...
figure_06 <-
  plot_distribution( 
    ...
    paste("Figure", 
          J+1,
          " Sampling distribution of the mean with n = 8",
          n[J]))

    figure_06                                   # Display plot.
                              

ggsave( "figure_06.png",                        # Save plot.            
        plot = figure_06,
        path = 
          file.path( 
            here(),
...
figure_06qq <-                                 # Assess normality of the
  plot_qq_norm(                                # sampling distribution.
    variable = distribution,
    R = 100,
    variable_name = "Sample means",
    plot_title = "Normal QQ plot of sampling distribution with n = 16" )

figure_06qq

ggsave( "figure_06qq.png",                # Save plot.            
        plot = figure_06qq,
        path = 
          file.path( 
            here(),
